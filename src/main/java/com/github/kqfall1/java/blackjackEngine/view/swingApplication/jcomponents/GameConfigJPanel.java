 ...
 *
 * <p>Encapsulates an {@code InputManager} that accepts input from {@code NumberJTextField} objects. Implements
 * {@code ErrorPresenter} to improve the application's user experience.</p>
 *
 * @author kqfall1
 * @since 14/02/2026
 */
