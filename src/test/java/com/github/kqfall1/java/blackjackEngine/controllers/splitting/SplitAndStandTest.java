 ...
 * @since 23/12/2025
 */
final class SplitAndStandTest extends SplitTest
{
	private static final String LOG_FILE_PATH = "src/main/resources/tests/logs/SplitAndStandTest.log";
	private static final String LOGGER_NAME = "com.github.kqfall1.java.blackjackEngine.controllers.splitting.SplitAndStandTest.log";
